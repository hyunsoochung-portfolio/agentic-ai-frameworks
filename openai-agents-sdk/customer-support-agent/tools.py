"""Function tools (one set per specialist) plus an AgentHooks logger.

Every tool takes the UserAccountContext as its first argument; the SDK injects
it automatically at call time. The @function_tool decorator turns the function
signature + docstring into a JSON schema the model can call.

These tools return mock/demo data — this is a learning project.
"""
...
class AgentToolUsageLoggingHooks(AgentHooks):
    """Logs agent lifecycle / tool-usage events into the Streamlit sidebar."""
